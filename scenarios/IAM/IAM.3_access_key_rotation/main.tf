...
# IAM.3 — VULNERABLE: access key rotation > 90 days cannot be detected in IaC
# Operational state — key age is determined at runtime, not from Terraform code
resource "aws_iam_access_key" "cis_test" {
