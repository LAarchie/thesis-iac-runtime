...
# CloudWatch log group and IAM role preserved but not attached to CloudTrail — that is the vulnerability
...
# CloudTrail.5 — VULNERABLE: cloud_watch_logs_* fields removed
